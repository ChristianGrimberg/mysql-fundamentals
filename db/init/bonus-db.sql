...
-- Punto 2
DROP TABLE IF EXISTS bonus.puestos;
CREATE TABLE bonus.puestos (
    puesto_id SMALLINT
...
DROP TABLE IF EXISTS bonus.locales;
CREATE TABLE bonus.locales (
    local_id CHAR(4)
    ,nombre VARCHAR(40)
    ,direccion VARCHAR(40)
    ,ciudad VARCHAR(20)
...
DROP TABLE IF EXISTS bonus.libros;
CREATE TABLE bonus.libros (
    libro_id VARCHAR(6)
    ,titulo VARCHAR(80)
    ,categoria CHAR(12)
    ,editorial_id CHAR(4)
...
DROP TABLE IF EXISTS bonus.ventas;
CREATE TABLE bonus.ventas (
    local_id CHAR(4)
...
DROP TABLE IF EXISTS bonus.libroautor;
CREATE TABLE bonus.libroautor (
    autor_id VARCHAR(11)
    ,libro_id VARCHAR(6)
);

DROP TABLE IF EXISTS bonus.editoriales;
CREATE TABLE bonus.editoriales (
    editorial_id CHAR(4)
    ,nombre VARCHAR(40)
    ,ciudad VARCHAR(20)
    ,provincia CHAR(2)
...
-- Punto 4
ALTER TABLE bonus.puestos
ADD PRIMARY KEY(puesto_id);

ALTER TABLE bonus.autores
ADD PRIMARY KEY(autor_id);

ALTER TABLE bonus.locales
ADD PRIMARY KEY(local_id);

ALTER TABLE bonus.libros
ADD PRIMARY KEY(libro_id);

ALTER TABLE bonus.empleados
ADD PRIMARY KEY(empleado_id);

ALTER TABLE bonus.ventas
ADD PRIMARY KEY(local_id,factura_nro,libro_id);

ALTER TABLE bonus.libroautor
ADD PRIMARY KEY(autor_id,libro_id);

ALTER TABLE bonus.editoriales
